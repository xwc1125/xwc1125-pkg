...
// -p 8600:8600 \
//
//consul:1.15.4 agent -server -ui -node=n1 -bootstrap-expect=1 -client=0.0.0.0 -advertise=192.168.0.112
func TestRegister(t *testing.T) {
	addr := fmt.Sprintf("%s:8082", getIntranetIP())
